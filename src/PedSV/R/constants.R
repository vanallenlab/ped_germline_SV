...
load.constants <- function(subset, envir=.GlobalEnv){
  ...
  scales <- list(
    ...
    "logscale.major.bp.labels" = c(sapply(c("bp", "kb", "Mb"),
                                          function(suf){paste(c(1, 10, 100), suf)}),
                                   "1 Gb"),
    ...
    "logscale.demi.bp.labels" = c(paste(c(1, 5, 10, 50, 100, 500), "bp"),
                                  paste(c(1, 5, 10, 50, 100, 500), "kb"),
                                  paste(c(1, 5, 10, 50, 100, 500), "Mb"),
                                  paste(c(1, 5), "Gb")),
