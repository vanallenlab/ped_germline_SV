...
write_tsv(neuroblastoma_all_SVs_in_each_category_list_combined,here::here("data","neuroblastoma_all_coding_SVs_in_each_category_list_combined_4_11_24.txt"))
...
write_tsv(ewing_all_SVs_in_each_category_list_combined,here::here("data","ewing_all_coding_SVs_in_each_category_list_combined_4_11_24.txt"))
...
neuroblastoma_all_SVs_in_each_category_list_combined <- read_tsv(here::here("data","neuroblastoma_all_coding_SVs_in_each_category_list_combined_4_11_24.txt"))
...
write_tsv(neuroblastoma_all_unique_list_of_categories_list[[index]] %>% as_tibble(),here::here("data/neuroblastoma_all_coding_CWAS_category_shards_BURDEN_TESTING_4_11_24",str_c("neuroblastoma_all_coding_shard_",index,".txt")), col_names = FALSE)
...
ewing_all_SVs_in_each_category_list_combined <- read_tsv(here::here("data","ewing_all_coding_SVs_in_each_category_list_combined_4_11_24.txt"))
...
write_tsv(ewing_all_unique_list_of_categories_list[[index]] %>% as_tibble(),here::here("data/ewing_all_coding_CWAS_category_shards_BURDEN_TESTING_4_11_24",str_c("ewing_all_coding_shard_",index,".txt")), col_names = FALSE)
