...
neuroblastoma_cwas_concatenated_glm_results_permuted_z_score_matrix <- read_tsv(here::here("data","neuroblastoma_all_coding_cwas_concatenated_glm_results_permuted_z_score_matrix_4_11_24.txt"), col_names = FALSE) %>% column_to_rownames("X1") %>% remove_missing()
...
threshold_for_multiple_hypothesis_significance_neuroblastoma_all_cohort <- .05/321
...
neuroblastoma_cwas_concatenated_glm_results_all_bonferroni_significant_categories <- neuroblastoma_cwas_concatenated_glm_results %>% filter(p_value < .05/321) %>% dplyr::select(category_name) %>% unlist() %>% unname()
...
write_tsv(neuroblastoma_cwas_concatenated_glm_results_RARE, here::here("data","neuroblastoma_all_coding_cwas_concatenated_glm_results_RARE_4_11_24.txt"))
...
ggsave(here::here("results","neuroblastoma_all_coding_cwas_concatenated_glm_results_RARE_plot_4_11_24.png"),neuroblastoma_cwas_concatenated_glm_results_RARE_plot)
...
write_tsv(neuroblastoma_cwas_concatenated_glm_results_SINGLETON, here::here("data","neuroblastoma_all_coding_cwas_concatenated_glm_results_SINGLETON_4_11_24.txt"))
...
ggsave(here::here("results","neuroblastoma_all_coding_cwas_concatenated_glm_results_SINGLETON_plot_4_11_24.png"),neuroblastoma_cwas_concatenated_glm_results_SINGLETON_plot)
...
ewing_cwas_concatenated_glm_results_permuted_z_score_matrix <- read_tsv(here::here("data","ewing_all_coding_cwas_concatenated_glm_results_permuted_z_score_matrix_4_11_24.txt"), col_names = FALSE) %>% column_to_rownames("X1") %>% remove_missing()
...
threshold_for_nominal_significance <- .05
threshold_for_multiple_hypothesis_significance_ewing_all_cohort <- .05/322
...
ewing_cwas_concatenated_glm_results <- read_tsv(here::here("data","ewing_all_coding_cwas_concatenated_glm_results_4_11_24.txt"), col_names = ewing_cwas_concatenated_glm_results_col_names) %>% mutate(sv_type = str_split_fixed(category_name,"\\.",6)[,1], frequency = str_split_fixed(category_name,"\\.",6)[,2], mean_SVs_per_case = SV_counts_cases/total_cases, mean_SVs_per_control = SV_counts_controls/total_controls, mean_SVs_total = ((SV_counts_cases + SV_counts_controls)/ (total_cases + total_controls)))
...
ewing_cwas_concatenated_glm_results_all_bonferroni_significant_categories <- ewing_cwas_concatenated_glm_results %>% filter(p_value < .05/322) %>% dplyr::select(category_name) %>% unlist() %>% unname()
...
write_tsv(ewing_cwas_concatenated_glm_results_RARE, here::here("data","ewing_all_coding_cwas_concatenated_glm_results_RARE_4_11_24.txt"))
...
ggsave(here::here("results","ewing_all_coding_cwas_concatenated_glm_results_RARE_plot_4_11_24.png"),ewing_cwas_concatenated_glm_results_RARE_plot)
...
write_tsv(ewing_cwas_concatenated_glm_results_SINGLETON, here::here("data","ewing_all_coding_cwas_concatenated_glm_results_SINGLETON_4_11_24.txt"))
...
ggsave(here::here("results","ewing_all_coding_cwas_concatenated_glm_results_SINGLETON_plot_4_11_24.png"),ewing_cwas_concatenated_glm_results_SINGLETON_plot)
...
ggsave(here::here("results","neuroblastoma_all_coding_cwas_concatenated_glm_results_plot_4_11_24.png"),neuroblastoma_cwas_concatenated_glm_results_plot)
...
ggsave(here::here("results","ewing_all_coding_cwas_concatenated_glm_results_plot_4_11_24.png"),ewing_cwas_concatenated_glm_results_plot)
