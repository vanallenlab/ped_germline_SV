...
neuroblastoma_all_SVs_in_each_category_list_combined <- read_tsv(here::here("data","neuroblastoma_all_noncoding_SVs_in_each_category_list_combined_BURDEN_TESTING_12_26_23.txt"), col_names = c("SV","chrom","start","emd","category"))

write_tsv(neuroblastoma_all_SVs_in_each_category_list_combined,here::here("data","neuroblastoma_all_noncoding_SVs_in_each_category_list_combined_BURDEN_TESTING_with_col_names_12_26_23.txt"))
...
write_tsv(neuroblastoma_all_unique_list_of_categories_list[[index]] %>% as_tibble(),here::here("data/neuroblastoma_all_noncoding_CWAS_category_shards_BURDEN_TESTING_12_26_23",str_c("neuroblastoma_all_noncoding_shard_",index,".txt")), col_names = FALSE)
...
ewing_all_SVs_in_each_category_list_combined <- read_tsv(here::here("data","ewing_all_noncoding_SVs_in_each_category_list_combined_BURDEN_TESTING_12_26_23.txt"), col_names = c("SV","chrom","start","emd","category"))

write_tsv(ewing_all_SVs_in_each_category_list_combined,here::here("data","ewing_all_noncoding_SVs_in_each_category_list_combined_BURDEN_TESTING_with_col_names_12_26_23.txt"))
...
write_tsv(ewing_all_unique_list_of_categories_list[[index]] %>% as_tibble(),here::here("data/ewing_all_noncoding_CWAS_category_shards_BURDEN_TESTING_12_26_23",str_c("ewing_all_noncoding_shard_",index,".txt")), col_names = FALSE)
