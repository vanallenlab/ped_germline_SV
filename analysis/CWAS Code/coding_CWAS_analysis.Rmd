...
neuroblastoma_cwas_concatenated_glm_results_permuted_z_score_matrix <- read_tsv(here::here("data","neuroblastoma_all_coding_cwas_concatenated_glm_results_permuted_z_score_matrix_12_26_23.txt"), col_names = FALSE) %>% column_to_rownames("X1") %>% remove_missing()
...
threshold_for_multiple_hypothesis_significance_neuroblastoma_all_cohort <- .05/279

```

#CWAS statistics - RARE and SINGLETON categories
```{r}
...
neuroblastoma_cwas_concatenated_glm_results_all_bonferroni_significant_categories <- neuroblastoma_cwas_concatenated_glm_results %>% filter(p_value < .05/279) %>% dplyr::select(category_name) %>% unlist() %>% unname()
...
write_tsv(neuroblastoma_cwas_concatenated_glm_results_RARE, here::here("data","neuroblastoma_all_coding_cwas_concatenated_glm_results_RARE_12_26_23.txt"))
...
ggsave(here::here("results","neuroblastoma_all_coding_cwas_concatenated_glm_results_RARE_plot_12_26_23.png"),neuroblastoma_cwas_concatenated_glm_results_RARE_plot)
...
write_tsv(neuroblastoma_cwas_concatenated_glm_results_SINGLETON, here::here("data","neuroblastoma_all_coding_cwas_concatenated_glm_results_SINGLETON_12_26_23.txt"))
...
ggsave(here::here("results","neuroblastoma_all_coding_cwas_concatenated_glm_results_SINGLETON_plot_12_26_23.png"),neuroblastoma_cwas_concatenated_glm_results_SINGLETON_plot)
...
ewing_cwas_concatenated_glm_results_permuted_z_score_matrix <- read_tsv(here::here("data","ewing_all_coding_cwas_concatenated_glm_results_permuted_z_score_matrix_12_26_23.txt"), col_names = FALSE) %>% column_to_rownames("X1") %>% remove_missing()
...
threshold_for_nominal_significance <- .05
threshold_for_multiple_hypothesis_significance_ewing_all_cohort <- .05/267
...
ewing_cwas_concatenated_glm_results <- read_tsv(here::here("data","ewing_all_coding_cwas_concatenated_glm_results_12_26_23.txt"), col_names = ewing_cwas_concatenated_glm_results_col_names) %>% mutate(sv_type = str_split_fixed(category_name,"\\.",6)[,1], frequency = str_split_fixed(category_name,"\\.",6)[,2], mean_SVs_per_case = SV_counts_cases/total_cases, mean_SVs_per_control = SV_counts_controls/total_controls, mean_SVs_total = ((SV_counts_cases + SV_counts_controls)/ (total_cases + total_controls)))
...
ewing_cwas_concatenated_glm_results_all_bonferroni_significant_categories <- ewing_cwas_concatenated_glm_results %>% filter(p_value < .05/267) %>% dplyr::select(category_name) %>% unlist() %>% unname()
...
write_tsv(ewing_cwas_concatenated_glm_results_RARE, here::here("data","ewing_all_coding_cwas_concatenated_glm_results_RARE_12_26_23.txt"))
...
ggsave(here::here("results","ewing_all_coding_cwas_concatenated_glm_results_RARE_plot_12_26_23.png"),ewing_cwas_concatenated_glm_results_RARE_plot)
...
write_tsv(ewing_cwas_concatenated_glm_results_SINGLETON, here::here("data","ewing_all_coding_cwas_concatenated_glm_results_SINGLETON_12_26_23.txt"))
...
ggsave(here::here("results","ewing_all_coding_cwas_concatenated_glm_results_SINGLETON_plot_12_26_23.png"),ewing_cwas_concatenated_glm_results_SINGLETON_plot)
...
neuroblastoma_cwas_concatenated_glm_results_plot <- ggplot(neuroblastoma_cwas_concatenated_glm_results, aes(x = point_estimate, y = negative_log10_p_value,fill = frequency)) + geom_point(stroke = 0, alpha = 1, size = 3, shape = 21) + scale_fill_manual(values = c("#763A82","#C494CE"), labels = c("Rare","Singleton"))+ geom_hline(yintercept = -log10(threshold_for_multiple_hypothesis_significance_neuroblastoma_all_cohort), linetype = 2) + geom_hline(yintercept = -log10(.05), linetype = 2, color = "black") + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.ticks.x=element_blank(),  axis.ticks.y=element_blank(), axis.text.y = element_text(size = 16, color = "black"), axis.text.x = element_text(size = 16, color = "black"), axis.title = element_text(size = 18, color = "black"), title = element_text(size = 16, color = "black"), legend.position= c(0.2,0.9), legend.title = element_blank(),legend.text = element_text(size = 18, color = "black")) + labs(title = "Neuroblastoma coding CWAS", x = expression("Odds Ratio (Cases vs. Controls)"), y = expression(paste(-log[10],italic(" P")))) + scale_x_continuous(limits = c(-2.5,2.5), breaks = c(log(0.125),log(0.25),log(.5),log(0),log(1),log(2),log(4),log(8)), labels = c(0.125,0.25,0.5,0,1,2,4,8))

ggsave(here::here("results","neuroblastoma_all_coding_cwas_concatenated_glm_results_plot_2_13_24_v3.png"),neuroblastoma_cwas_concatenated_glm_results_plot)

#Ewing sarcoma

ewing_cwas_concatenated_glm_results_plot <- ggplot(ewing_cwas_concatenated_glm_results, aes(x = point_estimate, y = negative_log10_p_value,fill = frequency)) + geom_point(stroke = 0, alpha = 1, size = 3, shape = 21) + scale_fill_manual(values = c("#3B5CB0","#95AFF3"), labels = c("Rare","Singleton")) + geom_hline(yintercept = -log10(threshold_for_multiple_hypothesis_significance_ewing_all_cohort), linetype = 2) + geom_hline(yintercept = -log10(.05), linetype = 2, color = "black") + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), axis.ticks.x=element_blank(),  axis.ticks.y=element_blank(), axis.text.y = element_text(size = 16, color = "black"), axis.text.x = element_text(size = 16, color = "black"), axis.title = element_text(size = 18, color = "black"), title = element_text(size = 16, color = "black"), legend.position= c(0.2,0.9), legend.title = element_blank(),legend.text = element_text(size = 18, color = "black")) + labs(title = "Ewing sarcoma coding CWAS", x = expression("Odds Ratio (Cases vs. Controls)"), y = expression(paste(-log[10],italic(" P")))) + scale_x_continuous(limits = c(-2.5,2.5), breaks = c(log(0.125),log(0.25),log(.5),log(0),log(1),log(2),log(4),log(8)), labels = c(0.125,0.25,0.5,0,1,2,4,8))

ggsave(here::here("results","ewing_all_coding_cwas_concatenated_glm_results_plot_2_13_24_v3.png"),ewing_cwas_concatenated_glm_results_plot)
