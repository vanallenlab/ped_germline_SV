...
neuroblastoma_cwas_concatenated_glm_results_permuted_z_score_matrix <- read_tsv(here::here("data","neuroblastoma_all_noncoding_cwas_concatenated_glm_results_permuted_z_score_matrix_12_26_23.txt"), col_names = FALSE) %>% column_to_rownames("X1") %>% remove_missing()
...
write_tsv(neuroblastoma_cwas_concatenated_glm_results_RARE, here::here("data","neuroblastoma_all_noncoding_cwas_concatenated_glm_results_RARE_12_26_23.txt"))
...
ggsave(here::here("results","neuroblastoma_all_noncoding_cwas_concatenated_glm_results_RARE_plot_12_26_23.png"),neuroblastoma_cwas_concatenated_glm_results_RARE_plot)
...
write_tsv(neuroblastoma_cwas_concatenated_glm_results_SINGLETON, here::here("data","neuroblastoma_all_noncoding_cwas_concatenated_glm_results_SINGLETON_12_26_23.txt"))
...
ggsave(here::here("results","neuroblastoma_all_noncoding_cwas_concatenated_glm_results_SINGLETON_plot_12_26_23.png"),neuroblastoma_cwas_concatenated_glm_results_SINGLETON_plot)
...
pdf(file=here::here("results","neuroblastoma_noncoding_CWAS_QQ_3_26_24.pdf"),height=2, width=2)
...
ewing_cwas_concatenated_glm_results_permuted_z_score_matrix <- read_tsv(here::here("data","ewing_all_noncoding_cwas_concatenated_glm_results_permuted_z_score_matrix_12_26_23.txt"), col_names = FALSE) %>% column_to_rownames("X1") %>% remove_missing()
...
threshold_for_nominal_significance <- .05
threshold_for_multiple_hypothesis_significance_ewing_all_cohort <- .05/916
...
ewing_cwas_concatenated_glm_results <- read_tsv(here::here("data","ewing_all_noncoding_cwas_concatenated_glm_results_12_26_23.adjusted.txt"), col_names = ewing_cwas_concatenated_glm_results_col_names) %>% mutate(sv_type = str_split_fixed(category_name,"\\.",6)[,1], frequency = str_split_fixed(category_name,"\\.",6)[,2], mean_SVs_per_case = SV_counts_cases/total_cases, mean_SVs_per_control = SV_counts_controls/total_controls, mean_SVs_total = ((SV_counts_cases + SV_counts_controls)/ (total_cases + total_controls)))
...
write_tsv(ewing_cwas_concatenated_glm_results_RARE, here::here("data","ewing_all_noncoding_cwas_concatenated_glm_results_RARE_12_26_23.txt"))
...
ggsave(here::here("results","ewing_all_noncoding_cwas_concatenated_glm_results_RARE_plot_12_26_23.png"),ewing_cwas_concatenated_glm_results_RARE_plot)
...
write_tsv(ewing_cwas_concatenated_glm_results_SINGLETON, here::here("data","ewing_all_noncoding_cwas_concatenated_glm_results_SINGLETON_12_26_23.txt"))
...
ggsave(here::here("results","ewing_all_noncoding_cwas_concatenated_glm_results_SINGLETON_plot_12_26_23.png"),ewing_cwas_concatenated_glm_results_SINGLETON_plot)
...
pdf(file=here::here("results","ewing_noncoding_CWAS_QQ_3_26_24.pdf"),height=2, width=2)
...
ggsave(here::here("results","neuroblastoma_all_noncoding_cwas_concatenated_glm_results_plot_3_15_24.png"),neuroblastoma_cwas_concatenated_glm_results_plot)
...
ggsave(here::here("results","ewing_all_noncoding_cwas_concatenated_glm_results_plot_3_15_24.png"),ewing_cwas_concatenated_glm_results_plot)

```

#Comparison of neuroblastoma and ewing noncoding cwas singleton categories: TAD boundary annotations vs no functional annotation
```{r}
...
ggsave(here::here("results","neuroblastoma_noncoding_categories_for_TAD_boundary_effect_size_comparisons_plot_3_26_24.png"), neuroblastoma_and_ewing_noncoding_categories_for_TAD_boundary_effect_size_comparisons_plot, width = 5.5, height = 7)
